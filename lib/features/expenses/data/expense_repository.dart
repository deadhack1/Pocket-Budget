...
class ExpenseRepository{
  ...
  return rows.where((e)=> e.deletedAt==null).map((e)=>Expense(id: e.id,note:e.note,categoryId: e.categoryId,receiptUri: e.receiptUri,amountCents: e.amountCents, currency: e.currency, date: e.date, createdAt: e.createdAt, updatedAt: e.updatedAt, isDirty: e.isDirty)).toList();
  }
  Future<void> upsert(Expense exp) async {
    print("The value of note on db side is ${Value(exp.note)}");
